...
y genera todos los artefactos del B en `outputs/` (figuras `b*.png`, `alertas.csv`,
`informe_modulo_b.md`).
...
Uso:
    ...
    python main_modulo_b.py --rapido     # salta la inyección sintética (más veloz)
"""
...
from src import config_b as cb
from src import (
